	...
	private static class HomeworkLayout extends ViewGroup {
		...
		public boolean onTouchEvent(MotionEvent event) {
			...
			case MotionEvent.ACTION_UP: {
				...
				final ValueAnimator animator = ValueAnimator.ofFloat((float) this.divider, (float) (Position.WEEK.equals(this.position) ? this.positionWeek : Position.MONTH.equals(this.position) ? this.positionMonth : this.positionSplit));
